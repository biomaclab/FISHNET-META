...
def main():
    ...
    ap.add_argument("--method", default=DEFAULT_METHOD, help="CNN")
    ap.add_argument("--region", default=DEFAULT_REGION, help="global,atlantic")
    ...
    if region not in ("global", "atlantic"):
        raise ValueError("--region must be one of global or atlantic")
    ...
    if region == "global":
        models_dir = base / "global" / "models"
    elif region == "atlantic":
        models_dir = base / "atlantic" / "models"
